...
- 思考模式:DeepSeek / MiMo 等模型的 reasoning 输出
- 全书大纲:分剧情段规划结构
- 角色卡 / 世界观卡:分类管理
...
本仓库(`InkArk-AiWritingAgent`)是 **开源版本**。功能聚焦在"本地优先 + 用户自配 LLM",不包含:
- 服务端 / 用户账号 / 商业订阅体系
- 远程向量化(本地无服务端)
- 自动增量更新(请从 GitHub Releases 手动下载新版)

如果你需要"开箱即用、内置免费 API、云同步、自动更新",那是商业版(`M1ssbe4r/InkArk` 私有仓库),不公开。
